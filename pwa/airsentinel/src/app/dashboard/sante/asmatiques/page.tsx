...
export default function AsthmatiquesPage() {
  ...
  useEffect(() => {
    ...
    const fetchHealthData = async () => {
      ...
      try {
        ...
        const asthmaRec = data.find(r => r.profil.toLowerCase().includes("asthmatique"));
        setRecommendations(asthmaRec ? [asthmaRec] : []);
      } catch (err) {
    ...
    <main className="p-6 pb-24 max-w-5xl mx-auto animate-in fade-in duration-700">
      <header className="mb-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-3xl font-black text-[var(--text-primary)] mb-1">{t('health_title_1')}{t('health_prof_asthma')}</h1>
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl font-black text-[var(--text-primary)] mb-2">{rec?.profil || t('health_prof_asthma')}</h3>
